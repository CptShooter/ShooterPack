...
public class Info extends javax.swing.JDialog {
     ...
     */
    public Info(java.awt.Frame parent, boolean modal, String information) {
        super(parent, modal);
        initComponents();
        info = information;
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabelInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 545, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36))
            .addGroup(layout.createSequentialGroup()
                .addGap(267, 267, 267)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Info dialog = new Info(new javax.swing.JFrame(), true, info);
